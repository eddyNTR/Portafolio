...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    images: [
      ...
      'https://res.cloudinary.com/dxzybfya6/image/upload/v1771777418/769db7b6-1165-4a1f-a682-1d67db7a7711.png',
      'https://res.cloudinary.com/dxzybfya6/image/upload/v1771777421/2e8cd5b7-afa5-4a18-a97b-503a79ee3e03.png',
    ],
